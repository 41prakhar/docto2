...
a1.eventdisplay(null, new AsyncCallback<Event[]>() {
			...
			public void onSuccess(Event[] result) {
				...
				MaterialLabel l1= new MaterialLabel(result[i].getTopic());
				RootPanel.get("tt1").add(l1);
				}*/
				...
				MaterialButton reg=new MaterialButton("Register");
				...
				reg.addClickHandler(new ClickHandler() {
					...
					public void onClick(ClickEvent event) {
						...
						Event_Regist a=new Event_Regist();
